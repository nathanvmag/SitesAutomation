...
namespace MACAddressTool
{
    public partial class Form1 : Form
    {
        ...
        private async void button1_ClickAsync(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(login) && !string.IsNullOrEmpty(pass))
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    {
                        verificaApro(login, pass);

                    }
                    else
                    {
                        verificasaldo(login, pass);
                    }
        ...
        async         Task
verificaApro(string login,string pass)
        {
            if (!wk)
            {
                wk = true;
...

                {
                    ...
                    bool work = true;
                    int indx = 1;
                    string resultpath = "./aprovacoes/" + DateTime.Now.ToString("dd.MM.yyyy") + "/";
                    ...
                    string finaltx = "Status da conta :" + login + Environment.NewLine;
                    try
                    {
                        driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/lazy-onboarding/dynamic-component/onboarding/div/congratulations-card/div/article/footer/material-button[1]/div")).Click();
                        finaltx += "Conta ativada com sucesso"+Environment.NewLine;
                    }
                    catch
                    {
                        try
                        {
                            string errortx = driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/lazy-onboarding/dynamic-component/onboarding/div/resubmission/div/article/resubmission-violations/section[1]/ul/li/div/div")).Text;
                            finaltx += "Conta com erro " + errortx + Environment.NewLine;

                            if (errortx.Contains("construction")|| errortx.Contains("construção"))
                            {
                                try
                                {
                                    try
                                    {
                                        driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/lazy-onboarding/dynamic-component/onboarding/div/resubmission/div/article/resubmission-violations/section[2]/div/div/material-radio-group/material-radio[1]/div[1]/material-ripple")).Click();
                                        await Task.Delay(500);
                                        driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/lazy-onboarding/dynamic-component/onboarding/div/resubmission/div/footer/material-button/div")).Click();
                                        await Task.Delay(5000);
                                    }
                                    catch
                                    {
                                    ...
                                    driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/lazy-onboarding/dynamic-component/onboarding/div/div/onboarding-actions-single/dynamic-component/verification-setup/div/article/section/material-checkbox[2]/div[2]")).Click();
                                    await Task.Delay(500);
                                    driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/lazy-onboarding/dynamic-component/onboarding/div/div/onboarding-actions-single/dynamic-component/verification-setup/div/article/footer/material-button/div")).Click();
                                    await Task.Delay(4000);
                                    driver.FindElement(By.XPath("//*[@id='default-acx-overlay-container']/div[3]/pubcode-check-dialog/material-dialog/focus-trap/div[2]/div/main/div/div[3]/material-button/div")).Click();
                                    await Task.Delay(2000);

                                    finaltx += "Sucesso ao efetuar passos para reativação da conta" + Environment.NewLine;
                                }
                                catch (Exception ex)
                                {
                                    finaltx += "Falhou ao fazer procedimentos automatizado "+Environment.NewLine+ ex.ToString();
                                }
                            }
                        ...
                        catch
                        {
                            try
                            {
                                string ativaction = driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/lazy-onboarding/dynamic-component/onboarding/div/verification-pending/div/article/h2/span")).Text;
                                finaltx += "Ativando conta ";
                            }
                            catch
                            {
                                finaltx += "Não foi possível definir o status da conta";
                            }
        ...
        async         Task
verificasaldo(string login,string pass)

        {
            if (!wk)
            {
...

                {
                    ...
                    string resultpath = "./saldo/" + DateTime.Now.ToString("dd.MM.yyyy") + "/";
                    if (!Directory.Exists(resultpath)) Directory.CreateDirectory(resultpath);
                    StreamWriter writer = new StreamWriter(resultpath + login + ".txt");
                    try
                    {
                        ...
                        //driver.Navigate().GoToUrl(driver.Url.Replace("home", "sites/my-sites"));
                        await Task.Delay(5000);
                       // driver.FindElement(By.CssSelector("as-homepage-view-more-button-text._ngcontent-vak-24")).Click();
                       // await Task.Delay(5000);
                        string hoje = driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/as-home-tab/div[1]/as-homepage-grid/as-tile-container/as-tile-placeholder[1]/as-earnings-card/as-card-template/as-async-panel/div/article/section/as-refresh-panel/div/as-earnings-card-panel[1]/div")).Text;
                        string ontem = driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/as-home-tab/div[1]/as-homepage-grid/as-tile-container/as-tile-placeholder[1]/as-earnings-card/as-card-template/as-async-panel/div/article/section/as-refresh-panel/div/as-earnings-card-panel[2]/div[1]")).Text;
                        string estemes = driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/as-home-tab/div[1]/as-homepage-grid/as-tile-container/as-tile-placeholder[1]/as-earnings-card/as-card-template/as-async-panel/div/article/section/as-refresh-panel/div/as-earnings-card-panel[4]/div[1]")).Text;
                        finaltx += "GANHOS" + Environment.NewLine + Environment.NewLine;

                        finaltx += "Ganhos hoje: " + hoje + Environment.NewLine;
                        finaltx += "Ganhos ontem: " + ontem + Environment.NewLine;
                        finaltx += "Ganhos este mês: " + estemes + Environment.NewLine;

                        string pageview = driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/as-home-tab/div[1]/as-homepage-grid/as-tile-container/as-tile-placeholder[3]/as-performance-card/as-card-template/as-async-panel/div/article/section/as-refresh-panel/div/as-performance-card-panel[1]/div[2]")).Text;
                        string clicks = driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/as-home-tab/div[1]/as-homepage-grid/as-tile-container/as-tile-placeholder[3]/as-performance-card/as-card-template/as-async-panel/div/article/section/as-refresh-panel/div/as-performance-card-panel[4]/div[2]")).Text;
                        string cpc = driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/as-home-tab/div[1]/as-homepage-grid/as-tile-container/as-tile-placeholder[3]/as-performance-card/as-card-template/as-async-panel/div/article/section/as-refresh-panel/div/as-performance-card-panel[5]/div[2]")).Text;
                        string ctr =  driver.FindElement(By.XPath("//*[@id='bruschetta_container']/bruschetta-app/as-exception-handler/div/div/article/div/div/as-home/div/as-home-tab/div[1]/as-homepage-grid/as-tile-container/as-tile-placeholder[3]/as-performance-card/as-card-template/as-async-panel/div/article/section/as-refresh-panel/div/as-performance-card-panel[6]/div[2]")).Text;

                        finaltx += "PERFORMACE " + Environment.NewLine + Environment.NewLine;
                        finaltx += "Page vies: " + pageview + Environment.NewLine;
                        finaltx += "Clicks: " + clicks + Environment.NewLine;
                        finaltx += "CPC: " + cpc + Environment.NewLine;
                        finaltx += "CTR: " + ctr + Environment.NewLine;
                    ...
                    catch (Exception e)
                    {
                        try
                        {
                            string desa = driver.FindElement(By.ClassName("title")).Text;
                            finaltx += "Essa conta foi desativada";
                        }
                        catch
                        {
                            finaltx += "Não foi possivel acessar esta conta devido há algum erro"+Environment.NewLine;
                            finaltx += e.ToString()+Environment.NewLine;
                        }
                    }
        ...
        private async void button2_ClickAsync(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                if (openFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    bool whatwork = radioButton1.Checked;
                    if(checkBox1.Checked)
                    {
                        statuslabel.Text = "Status: Trocando Mac address";
                        UpdateButton_Click(sender, e);
                    ...
                    foreach (conta c in contas)
                    {
                        ...
                        if(whatwork)
                        {
                            await verificaApro(c.user, c.pass);

                        }else
                        {
                            await verificasaldo(c.user, c.pass);
                        }
